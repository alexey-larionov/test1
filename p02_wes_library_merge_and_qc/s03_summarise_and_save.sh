...
ssh "${data_server}" "chown -R ${mgqnap_user}:${mgqnap_group} ${project_location}/${project}/${library}/merged"
...
# Update logs on NAS
ssh "${data_server}" "echo \"Removed data from cluster\" >> ${project_location}/${project}/${library}/merged/f00_logs/s03_summarise_and_save.log"
ssh "${data_server}" "echo \"Removed data from cluster\" >> ${project_location}/${project}/${library}/merged/f00_logs/a00_pipeline_${project}_${library}.log"
