...
## s01_tabulate_vep_vcf.sb.sh
## Wes library: tabulating vep vcf
## SLURM submission script
## Alexey Larionov, 20Oct2015

## Name of the job:
#SBATCH -J tabulate_vep_vcf
