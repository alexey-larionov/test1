...
if [ "${line1}" != "Job description file for wes lane alignment and QC" ] && \
   ...
   [ "${line1}" != "Job description file for vqsr" ] && \
   [ "${line1}" != "Job description file for filtering raw vcfs by QUAL" ] && \
   [ "${line1}" != "Job description file for annotating filtered vcfs with vep" ] && \
   [ "${line1}" != "Job description file for tabulating vep vcf" ]
then
  echo "" 
