...
# Copy results
"${rsync}" -thrve ssh "${lane_folder}" "${results_server}:${results_folder}/${project}/${library}/"
...
ssh "${results_server}" "chown -R ${mgqnap_user}:${mgqnap_group} ${results_folder}/${project}/${library}/${lane}"
ssh "${results_server}" "chown -R ${mgqnap_user}:${mgqnap_group} ${results_folder}/${project}/${library}" # just in case...
ssh "${results_server}" "chown -R ${mgqnap_user}:${mgqnap_group} ${results_folder}/${project}" # just in case...
ssh "${results_server}" "chown -R ${mgqnap_user}:${mgqnap_group} ${results_folder}" # just in case...
...
# Update logs on NAS
ssh "${results_server}" "echo \"Removed data from cluster\" >> ${results_folder}/${project}/${library}/${lane}/f00_logs/s03_summarise_and_save.log"
ssh "${results_server}" "echo \"Removed data from cluster\" >> ${results_folder}/${project}/${library}/${lane}/f00_logs/a00_pipeline_${project}_${library}_${lane}.log"
